...
namespace ZDef.Bootsrtap
{
    ...
    public class BootstrapUIHostRoomMenu : MonoBehaviour
    {
        ...
        {
            _completion.TrySetResult(DialogResult.Ok);
        }
        ...
        private void LateUpdate()
        {
            ...
            {
                _playersInfo.SetText(string.Format(_playersInfoFormat, _room.Players.Count - 1, _room.MaxPlayers - 1)); // exclude host watcher
                _playButton.interactable = _room.Players.Count == _room.MaxPlayers;
